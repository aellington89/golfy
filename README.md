...
- **Phase 4** Polish (in progress) — system dark/light theme + empty states ([#16](https://github.com/aellington89/golfy/issues/16)) and editing a completed round's holes ([#17](https://github.com/aellington89/golfy/issues/17)); app icon, broader error handling, and per-hole yardage entry ([#22](https://github.com/aellington89/golfy/issues/22)) still to come
